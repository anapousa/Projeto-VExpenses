...
O primeiro passo foi reorganizar o arquivo main.tf em diferentes arquivos para que ele esteja estruturado de maneira mais clara e concisa. As mudanças foram:
